...
class CompanyProfile(Base):
    ...
    main_bank = Column(String(255), nullable=True)
    has_loan = Column(String(20), nullable=True)
    has_rent = Column(String(20), nullable=True)
    owner_age = Column(String(50), nullable=True)
    main_concern = Column(String(255), nullable=True)
    created_at = Column(DateTime, default=utcnow)
    updated_at = Column(DateTime, default=utcnow, onupdate=utcnow)
